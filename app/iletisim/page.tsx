            ...
            <div className="container mx-auto px-6 relative z-10">
                <header className="mb-20">
                    ...
                    <p className="text-white/40 text-xl max-w-xl">
                        Yeni bir proje, iş birliği veya sadece bir merhaba.
                ...
                <div className="grid lg:grid-cols-2 gap-20">
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="glass-panel p-8 flex items-start gap-6 group hover:border-primary-gold/30 transition-colors">
                            ...
                            <div>
                                <h3 className="font-display font-bold text-white text-lg mb-1">Telefon</h3>
                        ...
                        <div className="glass-panel p-8 flex items-start gap-6 group hover:border-primary-gold/30 transition-colors">
                            ...
                            <div>
                                <h3 className="font-display font-bold text-white text-lg mb-1">Ofis</h3>
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-display font-bold text-white mb-8">Hemen İletişime Geçin</h3>
