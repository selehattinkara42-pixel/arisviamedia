                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        <motion.h2
                            ...
                            className="text-primary-gold font-display font-bold tracking-[0.3em] uppercase mb-6 text-xs text-glow"
                        >
                        ...
                        <p className="text-xl text-white/50 max-w-lg mb-12 leading-relaxed font-body italic">
